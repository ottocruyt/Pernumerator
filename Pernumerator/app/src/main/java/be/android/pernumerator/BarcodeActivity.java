...
public final class BarcodeActivity extends AppCompatActivity implements BarcodeGraphicTracker.BarcodeUpdateListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPreview = findViewById(R.id.camera_source_preview);
    ...
    private void requestCameraPermission() {
        ...
        findViewById(R.id.barcodeTopLayout).setOnClickListener(listener);
